...
async function openTandemSearchPage(page: Page): Promise<void> {
  ...
  try {
    ...
    console.log("Warning: Could not find listing cards with standard selectors",error);
  }
}
...
/**
 * Prints scraped results to console in a formatted way
 * Makes output easy to read and understand
 *
 * @param listings - Array of scraped listings
 */
